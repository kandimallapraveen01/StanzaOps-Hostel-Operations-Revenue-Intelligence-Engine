/*
File: lookup_joins.sql
Purpose: Contains lookup-table creation, lookup data insertion,
         JOIN operations, and resident-level KPI aggregation
         queries for gender, city, state, payments, revenue,
         deposits, occupancy, and resident analysis.
Project: StanzaOps – Hostel Operations & Revenue Intelligence Engine
*/
USE stanzaops;
SHOW TABLES;
DESCRIBE Hostel_Management;
SELECT
    Resident_ID,
    Resident_Name,
    Gender,
